...
public class LoginDao implements LoginImplement {
    ...
    final String select = "SELECT *FROM  tbl_login ";
    final String insert = "INSERT INTO tbl_login (username,password,nama_lengkap) VALUES(?,?,?);";
    ...
    public Integer check(LoginModel l) {
        ...
        String check = "SELECT * FROM tbl_login WHERE Username = ? AND Password = ?;";
